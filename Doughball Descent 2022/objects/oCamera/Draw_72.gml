...
if(c1leftbounds>c2leftbounds) 
{
	...
	draw_sprite_ext(bgSprite,0,c2rightbounds-(bgX-modx)-c2width,y-camHeight/2-mody,bg2x,(camHeight+mody)/bgY,0,c_white,1) //Wrapping right side
}
else 
{ //things are broken by leftbounds moving probably should stop using it
	...
	draw_sprite_ext(bgSprite,0,drawX+modx-bgX,y-camHeight/2-mody,1+(c2width+modx)/bgX,(camHeight+mody)/bgY,0,c_white,1) //on right, left panel

...
{
	if(oPlayer.weight>=price && oPlayer.weight>oPlayer.weightCategories.minweight)
	{
		oPlayer.weight-=price
		if(oPlayer.weight<oPlayer.weightCategories.minweight) oPlayer.weight = oPlayer.weightCategories.minweight

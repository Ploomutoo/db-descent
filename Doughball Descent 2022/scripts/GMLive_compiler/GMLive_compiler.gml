...
function gml_compile_node(l_q, l_r, l_out) {
	...
	switch (l__g.__enumIndex__/* gml_node */) {
		...
		case 3/* other_const */: if (l_out) ds_list_add(l_r, gml_action_const(l__g.h_d, l__g.h_value)); break;
		case 13/* self */: ds_list_add(l_r, gml_action_self(l__g.h_d)); break;
		case 14/* other */: ds_list_add(l_r, gml_action_other(l__g.h_d)); break;
		case 15/* global_ref */: ds_list_add(l_r, gml_action_number(l__g.h_d, -5)); break;
		case 7/* ensure_array_for_local */: ds_list_add(l_r, gml_action_ensure_array_for_local(l__g.h_d, variable_struct_get(gml_compile_curr_script.h_local_map.h_obj, l__g.h_name))); break;
		case 8/* ensure_array_for_global */: ds_list_add(l_r, gml_action_ensure_array_for_global(l__g.h_d, l__g.h_name)); break;
		...
		case 39/* in */:
			...
			break;
		case 16/* script */: ds_list_add(l_r, gml_action_func_literal(l__g.h_d, l__g.h_ref.h_name)); break;
		case 18/* const */: ds_list_add(l_r, gml_action_const(l__g.h_d, variable_struct_get(gml_const_val.h_obj, l__g.h_id))); break;
		case 17/* native_script */: ds_list_add(l_r, gml_action_const(l__g.h_d, l__g.h_id)); break;
		case 5/* array_decl */:
			l_w = l__g.h_values;
		...
		case 6/* object_decl */:
			...
			for (l_i = 0; l_i < l_n; l_i++) {
				...
				var l__g1 = l_x;
				var l_bindFunc;
				if (l__g1.__enumIndex__/* gml_node */ == 31/* func_literal */) l_bindFunc = true; else l_bindFunc = false;
		...
		case 101/* var_decl */:
			...
			break;
		case 40/* local */: ds_list_add(l_r, gml_action_local(l__g.h_d, variable_struct_get(gml_compile_curr_script.h_local_map.h_obj, l__g.h_id))); break;
		case 41/* local_set */:
			if (gml_compile_node(l__g.h_val, l_r, true)) return true;
		...
		case 42/* local_aop */:
			...
			break;
		case 43/* global */: ds_list_add(l_r, gml_action_global(l__g.h_d, l__g.h_id)); break;
		case 44/* global_set */:
			if (gml_compile_node(l__g.h_val, l_r, true)) return true;
		...
		case 78/* raw_id2d_aop */:
			...
			ds_list_add(l_r, gml_action_index2d_aop(l__g.h_d, l__g.h_o));
			break;
		case 49/* env */: ds_list_add(l_r, gml_action_env(l__g.h_d, variable_struct_get(gml_var_refs.h_obj, l__g.h_id))); break;
		case 50/* env_set */:
			var l_s1 = l__g.h_id;
			if (gml_compile_node(l__g.h_val, l_r, true)) return true;
		...
		case 93/* ds_grid_aop */:
			...
			break;
		case 19/* arg_const */: ds_list_add(l_r, gml_action_arg_const(l__g.h_d, l__g.h_id)); break;
		case 20/* arg_index */:
			if (gml_compile_node(l__g.h_id, l_r, true)) return true;
			ds_list_add(l_r, gml_action_arg_index(l__g.h_d));
			break;
		case 21/* arg_count */: ds_list_add(l_r, gml_action_arg_count(l__g.h_d)); break;
		case 36/* set_op */:
			l_d = l__g.h_d;
			l_o = l__g.h_o;
			l_x = l__g.h_a;
		...
		case 34/* un_op */:
			...
			break;
		case 32/* prefix */: gml_compile_prefix_or_postfix(l__g.h_d, l__g.h_x, true, l__g.h_inc, l_r, l_out); break;
		case 33/* postfix */: gml_compile_prefix_or_postfix(l__g.h_d, l__g.h_x, false, l__g.h_inc, l_r, l_out); break;
		case 23/* call_script */:
			l_d = l__g.h_d;
			l_w = l__g.h_args;
			l_n = array_length(l_w);
		...
		case 28/* call_func */:
			...
			break;
		case 31/* func_literal */: ds_list_add(l_r, gml_action_func_literal(l__g.h_d, l__g.h_name)); break;
		case 102/* block */:
			l_w = l__g.h_nodes;
			l_n = array_length(l_w);
			if (l_n > 0) {
		...
		case 111/* repeat */:
			...
			for (l_k = l_p0; l_k < l_p2; l_k++) {
				...
				switch (l__g1.__enumIndex__/* gml_action */) {
					case 69/* continue */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p1)); break;
					case 68/* break */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p2)); break;
				}
			}
		...
		case 108/* while */:
			...
			for (l_k = l_p1; l_k < l_p2; l_k++) {
				var l__g1 = ds_list_find_value(l_r, l_k);
				switch (l__g1.__enumIndex__/* gml_action */) {
					case 69/* continue */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p0)); break;
					case 68/* break */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p2)); break;
				}
			}
			break;
		case 110/* do_while */:
			...
			var l__g1 = l_q;
			var l_tmp;
			if (l__g1.__enumIndex__/* gml_node */ == 109/* do_until */) l_tmp = true; else l_tmp = false;
		...
		case 112/* for */:
			...
			for (l_k = l_p1; l_k < l_p2; l_k++) {
				var l__g1 = ds_list_find_value(l_r, l_k);
				switch (l__g1.__enumIndex__/* gml_action */) {
					case 69/* continue */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p2)); break;
					case 68/* break */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p3)); break;
				}
			}
			break;
		case 105/* switch */:
		...
		case 113/* with */:
			...
			for (l_k = l_p0; l_k < l_p1; l_k++) {
				...
				switch (l__g1.__enumIndex__/* gml_action */) {
					case 69/* continue */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p0)); break;
					case 68/* break */: if (l__g1.h_lp == l_p0) ds_list_set(l_r, l_k, gml_action_jump(l__g1.h_d, l_p1)); break;
				}
			}
			break;
		case 120/* try_catch */:
		...
		case 106/* wait */:
			...
			break;
		case 107/* fork */: ds_list_add(l_r, gml_action_fork(l__g.h_d, l_out)); break;
